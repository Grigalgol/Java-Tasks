...
public class Task1 {
    public static void printFilteredAccounts(List<Account> accounts) {
        List<Account> nonEmptyAccounts = filter(accounts, account -> account.balance > 0);// write your code here
        List<Account> accountsWithTooMuchMoney = filter(accounts, account -> !account.locked && account.balance >= 100000000);// write your code here
